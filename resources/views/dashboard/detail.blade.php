...
@section("tittle", "Reactjs and Expressjs Implementation In PMK ITB STIKOM Bali Activity Management")

@section ("content")
    <div class="container detail-page mt-4 rounded bg-white">
        <div class="container pt-4 header-text">
            <h2 class="text-center fw-bold">Reactjs and Expressjs Implementation In PMK ITB STIKOM Bali Activity Management</h2>
        ...
        <div class="container information-text mt-5">
            ...
            <p><span class="fw-bold">KEYWORD :</span> Framework, Information, Management, Student, Website</p>
